...
public class ServiceManager {
    ...
    public RecipeService getRecipeService() { return retrofit.create(RecipeService.class); }

    public FavoriteService getFavoriteService() { return retrofit.create(FavoriteService.class); }

    public ReviewService getReviewService() { return retrofit.create(ReviewService.class); }

    public FriendService getFriendService() { return retrofit.create(FriendService.class); }
}
